    ...
    def construct(
        ...
        for (
            ...
            match target_class_str:
                ...
                case LLMLinguaPreviousSampleUtilizationCallback.__name__:
                    unique_flag = LLMLinguaPreviousSampleUtilizationCallback.is_unique()
                    first_chat_history_item = task.chat_history_item_factory.construct(
                        0, expected_role=Role.USER
                    )
                    general_instance_factory.parameters[
                ...
                case RetrievalPreviousSampleUtilizationCallback.__name__:
                    unique_flag = RetrievalPreviousSampleUtilizationCallback.is_unique()
                    first_chat_history_item = task.chat_history_item_factory.construct(
                        0, expected_role=Role.USER
                    )
                    general_instance_factory.parameters[
                ...
                case FailureAwareRetrievalPreviousSampleUtilizationCallback.__name__:
                    unique_flag = (
                        FailureAwareRetrievalPreviousSampleUtilizationCallback.is_unique()
                    )
                    first_chat_history_item = task.chat_history_item_factory.construct(
                        0, expected_role=Role.USER
                    )
                ...
                case RetrievalLLMLinguaPreviousSampleUtilizationCallback.__name__:
                    unique_flag = (
                        RetrievalLLMLinguaPreviousSampleUtilizationCallback.is_unique()
                    )
                    first_chat_history_item = task.chat_history_item_factory.construct(
                        0, expected_role=Role.USER
                    )
